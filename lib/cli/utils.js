 ...
 */
export async function * ndjsonStringify (source) {
  for await (const data of source) {
...
/**
 * @param {AsyncGenerator<object>|Iterable<object>} source
...
/**
 * @param {AsyncGenerator<import('../../index.js').EcosystemDependentsItem>} generator
 * @param {string[]|undefined} pkgFields
 * @returns {AsyncGenerator<import('./cli-types.d.ts').CliDependentsItem>}
 */
